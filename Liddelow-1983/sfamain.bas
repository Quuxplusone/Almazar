...
1017 IF IO=16 THEN IF OP(16)=RN THEN IF SP(3)=1 THEN RE=3:OP(16)=-1:GOTO 1098:ELSE RE=18:GOTO 1099
...
1106 IF IO=16 AND RE=3 THEN RE=66:SP(3)=0
...
1240 IF IV=20 AND IO=10 THEN GOSUB 1300
...
1610 IF OP(IO)<>-1 THEN RE=5:GOTO 1690
...
2200 RE=57:IF IO<>29 THEN RE=2:GOTO 2199
...
3199 GOSUB 7100:IF RE<>79 THEN RETURN ELSE PRINT:GOTO 7000
